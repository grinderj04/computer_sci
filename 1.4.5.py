...
def frame_all_images_fam(color, thickness, directory=None):
   
    if directory == None:
        directory = os.getcwd()
       
    new_directory = os.path.join(directory, 'My Framed Family')
    try:
        os.mkdir(new_directory)
    except OSError:
        pass
